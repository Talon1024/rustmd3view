...
impl Surface {
    ...
    pub fn read_image_data(
        ...
        match image {
            ...
            ImageLumaA8(_i) => {
                Err(Error::msg("Unsupported format: ImageLumaA8"))
            }
            ImageRgb8(i) => Ok(to_surface(i, U8RGB)),
            ImageRgba8(i) => Ok(to_surface(i, U8RGBA)),
            ImageLuma16(_i) => {
                Err(Error::msg("Unsupported format: ImageLuma16"))
            }
            ImageLumaA16(_i) => {
                Err(Error::msg("Unsupported format: ImageLumaA16"))
            }
...
pub const AXES_V: [VertexRes; 24] = [
    ...
    VertexRes {
        position: Vec3::new(0.0, 50.0, 1.0),
        colour: Vec3::new(0.0, 1.0, 0.0),
        normal: Vec3::new(-0.0, 0.0, 1.0),
    },
    VertexRes {
        position: Vec3::new(1.0, 50.0, 1.0),
        colour: Vec3::new(0.0, 1.0, 0.0),
        normal: Vec3::new(1.0, -0.0, 0.0),
    },
    VertexRes {
        position: Vec3::new(1.0, 50.0, 0.0),
        colour: Vec3::new(0.0, 1.0, 0.0),
        normal: Vec3::new(-0.0, 0.0, -1.0),
    },
    VertexRes {
    ...
    VertexRes {
        position: Vec3::new(50.0, 1.0, 0.0),
        colour: Vec3::new(1.0, 0.0, 0.0),
        normal: Vec3::new(0.0, 0.0, -1.0),
    },
    VertexRes {
        position: Vec3::new(50.0, 1.0, 1.0),
        colour: Vec3::new(1.0, 0.0, 0.0),
        normal: Vec3::new(-0.0, 0.0, 1.0),
    },
    VertexRes {
        position: Vec3::new(50.0, 0.0, 1.0),
        colour: Vec3::new(1.0, 0.0, 0.0),
    ...
    VertexRes {
        position: Vec3::new(1.0, 1.0, 50.0),
        colour: Vec3::new(0.1875, 0.4375, 1.0),
        normal: Vec3::new(1.0, -0.0, 0.0),
    },
    VertexRes {
        position: Vec3::new(0.0, 1.0, 50.0),
        colour: Vec3::new(0.1875, 0.4375, 1.0),
        normal: Vec3::new(-1.0, -0.0, 0.0),
    },
    VertexRes {
    ...
    VertexRes {
        position: Vec3::new(1.0, 0.0, 50.0),
        colour: Vec3::new(0.1875, 0.4375, 1.0),
        normal: Vec3::new(1.0, -0.0, 0.0),
    },
    VertexRes {
...
pub const AXES_I: [u8; 90] = [
    0, 1, 2, 0, 2, 3, 4, 1, 0, 4, 0, 5, 6, 2, 1, 6, 1, 4, 7, 3, 2, 7, 2, 6, 5,
    0, 3, 5, 3, 7, 8, 9, 10, 8, 10, 11, 12, 9, 8, 12, 8, 13, 14, 10, 9, 14, 9,
    12, 15, 11, 10, 15, 10, 14, 13, 8, 11, 13, 11, 15, 16, 17, 18, 16, 18, 19,
    20, 17, 16, 20, 16, 21, 22, 18, 17, 22, 17, 20, 23, 19, 18, 23, 18, 22, 21,
    16, 19, 21, 19, 23,
];
...
pub const TAGAXES_V: [VertexRes; 60] = [
    ...
    VertexRes {
        position: Vec3::new(1.0, 30.0, -1.0),
        colour: Vec3::new(0.0, 1.0, 0.0),
        normal: Vec3::new(1.0, 0.0, 0.0),
    },
    VertexRes {
    ...
    VertexRes {
        position: Vec3::new(30.0, 1.0, 1.0),
        colour: Vec3::new(1.0, 0.0, 0.0),
        normal: Vec3::new(0.0, 1.0, -0.0),
    },
    VertexRes {
    ...
    VertexRes {
        position: Vec3::new(-1.0, -1.0, 30.0),
        colour: Vec3::new(0.1875, 0.4375, 1.0),
        normal: Vec3::new(-1.0, -0.0, -0.0),
    },
    VertexRes {
...
pub const TAGAXES_I: [u8; 90] = [
    0, 1, 2, 0, 2, 3, 4, 5, 6, 4, 6, 7, 8, 9, 10, 8, 10, 11, 12, 13, 14, 12,
    14, 15, 16, 17, 18, 16, 18, 19, 20, 21, 22, 20, 22, 23, 24, 25, 26, 24, 26,
    27, 28, 29, 30, 28, 30, 31, 32, 33, 34, 32, 34, 35, 36, 37, 38, 36, 38, 39,
    40, 41, 42, 40, 42, 43, 44, 45, 46, 44, 46, 47, 48, 49, 50, 48, 50, 51, 52,
    53, 54, 52, 54, 55, 56, 57, 58, 56, 58, 59,
];
